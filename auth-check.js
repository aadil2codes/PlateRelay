    ...
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            try {
                ...
                if (path.endsWith('index.html') || path === '/' || path.endsWith('plateshare-vanilla/') || path.endsWith('login.html') || path.endsWith('register.html')) {
...
if (currentPath.endsWith('index.html') || currentPath === '/' || currentPath.endsWith('plateshare-vanilla/') || currentPath.endsWith('login.html') || currentPath.endsWith('register.html')) {
    checkAuth();
}
